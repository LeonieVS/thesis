...
"""
class ID_Hate(BaseEstimator, TransformerMixin):
...
class FeatureExtractor(BaseEstimator, TransformerMixin): #takes care of POS --> uit nltk
    #"""Extracts PoS-tags from each artikelument"""
    def fit(self, x, y=None):
        return self
...
pred = feature_pipeline.predict(X_test)
